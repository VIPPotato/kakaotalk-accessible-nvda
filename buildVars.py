...
addon_info = AddonInfo(
	...
	addon_name="KakaoTalkAccessible",
...
Reduced braille-related stalls in menus and message input handling."""),
	...
	addon_url="https://github.com/VIPPotato/kakaotalk-accessible-nvda",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/VIPPotato/kakaotalk-accessible-nvda",
